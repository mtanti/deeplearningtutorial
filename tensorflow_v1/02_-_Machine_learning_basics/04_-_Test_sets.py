...
[ train_error_plot ] = axs[1].plot([], [], color='red', linestyle='-', linewidth=1, label='train') #This is just to have something on which to create the legend.
[ test_error_plot ] = axs[1].plot([], [], color='orange', linestyle='-', linewidth=1, label='test') #This is just to have something on which to create the legend.
