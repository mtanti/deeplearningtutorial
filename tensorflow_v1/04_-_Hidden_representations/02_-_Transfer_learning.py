...
with g.as_default():
    ...
    W = tf.get_variable('W', [2*2, len(token_vocab)], tf.float32, tf.random_normal_initializer(stddev=init_stddev))
    ...
    with tf.Session() as s:
        ...
        for epoch in range(1, max_epochs1+1):
...
with g.as_default():
    ...
    with tf.Session() as s:
        ...
        for epoch in range(1, max_epochs2+1):
        ...
        trigrams_shown = set()
        print('3gram', 'top 3 predicted POS tags for middle word', sep='\t')
