...
de_dW3  = lambda i,j:2*(a3(i) - t[:,i]) * da3_dW3(i,j)
...
de_db3  = lambda i:2*(a3(i) - t[:,i]) * da3_db3(i)
...
de_dW2  = lambda i,j,k:2*(a3(i) - t[:,i]) * da3_dW2(i,j,k)
...
de_db2  = lambda i,j:2*(a3(i) - t[:,i]) * da3_db2(i,j)
...
de_dW1  = lambda i,k,l:2*(a3(i) - t[:,i]) * da3_dW1(i,k,l)
...
de_db1  = lambda i,k:2*(a3(i) - t[:,i]) * da3_db1(i,k)
